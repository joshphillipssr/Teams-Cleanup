...
function Teams-Cleanup {
    ...
    User-Notification -Title "Teams Cleanup Complete" -Message "Microsoft Teams cleanup has completed and is now ready to use. When you first launch Teams, select your <firstname.lastname@goodyearaz.gov> email account if it asks for one. `n`n Contact the Helpdesk at (623) 822-7850 if you have problems." -WaitBeforeStart $false
}
