...
function Teams-Cleanup {
    ...
    User-Notification -Title "Teams Cleanup Complete" -Message "Microsoft Teams cleanup has completed successfully, and is now ready to use. When you first launch teams, please select your firstname.lastname@goodyearaz.gov email account if it asks for one. If you encounter any problems with Teams, please contact the Helpdesk at 623-822-7850." -WaitBeforeStart $false
}
